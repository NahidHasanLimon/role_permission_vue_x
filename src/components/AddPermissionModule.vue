<template>
  <div>
    <button class="bg-cyan-900 text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" v-on:click="toggleModal()">
      Add Module 
    </button>
...
export default {
  ...
  methods: {
    ...
    submit: function(){
        ...
        axios.post('/api/module', formData).then((response) => {
