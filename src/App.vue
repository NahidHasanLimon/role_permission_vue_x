<template>
  <div id="app">
    ...
    <div class="text-sm lg:flex-grow">
       <router-link class="block mt-4 lg:inline-block lg:mt-0 text-cyan-200 hover:text-white mr-4" to="/">Home</router-link> |
       <template v-if="!authenticated">
        <router-link class="block mt-4 lg:inline-block lg:mt-0 text-cyan-200 hover:text-white mr-4" to="/signin">Sign in</router-link> |
      </template>
      <template v-else>
        <router-link class="block mx-4 lg:inline-block lg:mt-0 text-cyan-200 hover:text-white" to="/account">{{ user.name }}</router-link>
      </template>
      <slot>
      ...
      <slot> 
      <!-- <slot>  -->
        | <router-link class="block mx-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4" to="/test-access">Test Access</router-link>
      </slot>
      <slot>
